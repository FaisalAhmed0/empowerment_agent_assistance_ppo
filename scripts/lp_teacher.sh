...
WANDB_PROJECT_NAME="mlp_teacher_lp_reward_granular_sweep_over_teacher_eps_both_ent_coeff_teacher_lr_lp_ema_alpha_more_seeds_350M"
...
ABSOLUTE_LEARNING_PROGRESSS=(--no-ABSOLUTE_LEARNING_PROGRESS --ABSOLUTE_LEARNING_PROGRESS)
NUM_EVAL_ENVSS=(8)
TEACHER_ENTROPY_COEFSS=(0.01 0.001)
